...
for iter = 1:itermax % This can take a couple of minutes to run
  disp(iter)
  for d = 1:D
  ...
  swk_time(:, iter+1) = sum(swk);
end

plot([0:itermax], swk_time./sum(swk_time(:,1)));
xlabel('Iteration'); ylabel('Topic Posterior');
